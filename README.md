...
[요구사항 요약](docs/requirements/summary.md)이 비어 있거나 해석이 갈리는 자리에서 내린 결정을 모았다. 코드에도 같은 내용을 `// 자의적 결정:` 주석으로 남겨, 코드만 읽는 경우에도 결정과 실수를 구분할 수 있게 했다.

| 결정                                                                  | 근거                                                                                                                                                                                                                          | 위치                                                                |
| --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| 비밀번호를 "영문·숫자 **외 문자 불가**"로 해석 (영문만/숫자만도 통과) | 요구사항 문구 "영문, 숫자로 구성된"은 "둘 다 포함"으로도 읽히나, 스키마의 `^[A-Za-z0-9]+# kb-todo-app
...
| 결정                                                                  | 근거                                                                                                                                                                                                                          | 위치                                                                |
| --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| 비밀번호를 "영문·숫자 **외 문자 불가**"로 해석 (영문만/숫자만도 통과) | 요구사항 문구 "영문, 숫자로 구성된"은 "둘 다 포함"으로도 읽히나,  를 우선했다                                                                                                             | `pages/sign-in/ui/sign-in-page.tsx`                                 |
